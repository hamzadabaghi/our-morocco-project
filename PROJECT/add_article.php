												                                     ...
												                                     <div class="container-fluid text-center "  >    
												                                      <div class="row content my_center" style="padding-top: 57px;">
												                                        ...
												                                        <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 my_gallery" > 
												                                                ...
												                                                <div class="lead presentation" style="font-family: merienda;font-weight: bold;">
												                                                Ajouter un Article
												                                                </div>
												                                                <form method="POST" role="form" action="#" >
																							      <input class="form-control input-lg" type="text" name="article_titre" placeholder="Titre" /><br />
																							      <input class="form-control input-lg" name="resume" placeholder="résumé"></input><br/>
																							      <textarea class="form-control input-lg" name="article_contenu" placeholder="Contenu de l'article"></textarea><br />
																							      <button type="submit" name="article_aj" class="btn btn-primary btn-lg btn-block">Ajouter</button>
																							   </form>
																							   <br/>
																							   <h3>
																							  ...
																							  <?php if(isset($_POST['article_titre']) AND   isset($_POST['article_contenu']) AND  isset($_POST['resume'])) {
																							  	 if(!empty($_POST['article_titre']) AND   !empty($_POST['article_contenu']) AND  !empty($_POST['resume']) ){
												                                                                    ...
												                                                                    $mes='votre article a bien été ajouté';   	
												                                                             }
												                                                             else
												                                                             {
                                                                                 ...
                                                                                 $articles =$bdd->query('SELECT * from news ORDER BY  id_nws DESC limit 1 ');
                                                                                  ...
                                                                                  ?>
												                                        ...
												                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 sidenavi ">
												                                            ...
												                                            <div class="mynewsletter" class="col-xs-offset-1" style="background-color:#2c4201;padding-top: 16px;">
