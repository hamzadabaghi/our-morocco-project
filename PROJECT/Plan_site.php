                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                                ...
                                                                <div class="clearfix visible-ms-block visible-xs-block "></div>
                                                                                ...
                                                                                <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 "> 
                                                                                  ...
                                                                                  <h1 style="font-family: merienda;">Plan de Site</h1>

                                                                                <div class="partie_1 col-lg-6 col-xs-12 col-sm-12 col-md-6">
                                                                                                        
                                                                                

                                                                                  <h2><a href="Our_Morocco.php">Accueil</a></h2>
                                                                                  <h2><a href="qui_sommes_nous.php">Qui somme-nous ?</a></h2>
                                                                                ...
                                                                                <div class="partie_2 col-lg-6 col-xs-12 col-sm-12 col-md-6">

                                                                                  <h3><a href="site_et_monument.php">Sites et Monuments</a></h3>
                                                                                  <h3><a href="index_villes.php">Index des villes</a></h3>
                                                                                  <h3><a href="liens_utiles.php">Liens utiles</a></h3>
                                                                                  <h3><a href="https://www.google.com/maps/@33.9996347,-4.9897436,15z"  title=" cliquez pour voir tout le maroc 😍" target="_blank">la carte de du pays</a></h3>
