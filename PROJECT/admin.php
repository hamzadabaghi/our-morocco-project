												                                      ...
												                                      <div class="row content my_center" style="padding-top: 57px;">
												                                        ...
												                                        <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 my_gallery" > 
												                                                ...
												                                                <div class="lead presentation" >
				                                                                                  ...
				                                                                                  <h2><a href="article.php">Gestion des Articles</a></h2>
				                                                                                  <h2><a href="aff_msg.php">Les messages reçus</a></h2>
				                                                                                  <h2><a href="aff_nwsubs.php">Abonnés</a></h2>
                                                                                 ...
                                                                                 $articles =$bdd->query('SELECT * from news ORDER BY  id_nws DESC limit 1 ');
                                                                                  ...
                                                                                  ?>
												                                        ...
												                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 sidenavi ">
												                                            ...
												                                            <div class="mynewsletter" class="col-xs-offset-1" style="background-color:#2c4201;padding-top:12px;">
