												                                      ...
												                                      <div class="row content my_center" style="padding-top: 57px;">
												                                        ...
												                                        <div class="well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0" > 
												                                                ...
												                                                <div class="lead" style="font-size: 28px;color: #d6f52c;font-family: merienda;">
												                                                	ÉTABLISSEMENTS MAROCAINES !
												                                                </div>

												                                                <div class="gallery">
												                                                  <a  href="http://www.um5.ac.ma/um5r/" target="_blank">
												                                                    <img src="images/photos/MOHAMMED_RABAT.jpg" alt="Cinque Terre" width="600" height="600">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;">Université MOHAMMED V</div>
												                                                </div>


												                                                <div class="gallery">
												                                                  <a  href="https://www.uca.ma/" target="_blank">
												                                                    <img src="images/photos/QADI_AYAD.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;">Université QADI AYYAD</div>
												                                                </div>


												                                        
												                                                <div class="gallery">
												                                                  <a  href="https://www.fst-usmba.ac.ma/" target="_blank">
												                                                    <img src="images/photos/FST_FES.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;">USMBA : FST FES</div>
												                                                </div>
