												                                     ...
												                                     <div class="container-fluid text-center ">    
												                                      <div class="row content my_center" style="padding-top: 57px;">
												                                        ...
												                                        <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 my_gallery" > 
												                                                ...
												                                                <div class="lead" style="font-size: 28px;color: #d6f52c;font-family: merienda;">
												                                                	Monuments Historique !
												                                                </div>

												                                                <div class="gallery">
								
												                                                    <img class="img-responsive" src="images/photos/Marrakech_mosque.jpg" alt="Cinque Terre" width="600" height="600">
												                                                 
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;">Masjid KOUTOUBYA (Marrakech) </div>
												                                                </div>


												                                                <div class="gallery">
												                                                 
												                                                    <img class="img-responsive"  src="images/photos/tanger_hercules.jpg" alt="Cinque Terre" width="600" height="400">
												                                                
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;">Grottes d'Hercule (Tanger) </div>
												                                                </div>
												                                                ...
												                                                <div class="gallery">
												                                                    ...
												                                                    <img class="img-responsive"  src="images/photos/Fes_medina.jpg" alt="Cinque Terre" width="600" height="400">
												                                                 
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;">Ancienne médina (FES) </div>
												                                                </div>
