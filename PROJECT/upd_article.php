												                                        ...
												                                        <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 my_gallery" > 
												                                               ...
												                                               <?php
																									...
																									if(isset($_GET['id']) AND !empty($_GET['id'])) {
																									  ...
																									  $aff_avant_sup = $bdd->prepare('SELECT * FROM news WHERE id_nws = ?');
																									  $aff_avant_sup->execute(array($suppr_id));
																										$a=$aff_avant_sup->fetch();
												                                                ...
												                                                <form method="POST" >
																							      <input class="form-control input-lg" type="text" name="article_titre" value="<?php echo $a['titre'] ?>"  /><br />
																							      <input class="form-control input-lg" name="resume" value="<?php echo $a['resume'] ?> "></input> <br/>
																							      <textarea class="form-control input-lg" name="article_contenu" ><?php echo $a['contenu'] ?></textarea><br />
																							      <button type="submit" name="article_aj" class="btn btn-primary btn-lg btn-block">Modifier</button>
																							   </form>
																							    <h3>
											                                                            ...
											                                                            <?php
																								$aff_avant_sup->closeCursor(); // Termine le traitement de la requête

																								?>
																							  <?php if(isset($_POST['article_titre']) AND   isset($_POST['article_contenu']) AND  isset($_POST['resume'])) {
																							  	 if(!empty($_POST['article_titre']) AND   !empty($_POST['article_contenu']) AND  !empty($_POST['resume']) ){


 																													$suppr->execute(array($suppr_id));

												                                                                 	$requette=$bdd->prepare("INSERT  INTO news(date_pub,titre,contenu,resume) VALUES(Now(),?,?,?)");
												                                                                 	$requette->execute(array($_POST['article_titre'],$_POST['article_contenu'],$_POST['resume']));
												                                                                    $mes='votre article a bien été Modifié';  
												                                                                    
												                                                             }
												                                                             else
												                                                             {
												                                                             	$mes='Veuillez remplir tous les champs';   	
												                                                             }
