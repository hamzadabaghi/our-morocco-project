                                            ...
                                            <!--end of treat-->
                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                                ...
                                                                <div class="clearfix visible-ms-block visible-xs-block "></div>
                                                                                 ...
                                                                                 $nwsub =$bdd->query('SELECT * from internaute ORDER BY  id_inot DESC');
                                                                                ...
                                                                                <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 "> 
                                                                                  ...
                                                                                  <h1 style="font-family: merienda;font-weight: bold;">les abonnés à la newsletter</h1>
                                                                                    <br/> 
                                                                                  ...
                                                                                  <table  class="col-xs-12 table table-bordered table-responsive">
                                                                                    <tr style="background-color: #18185e;">
                                                                                  	...
                                                                                  	<th style="text-align: center;font-family: merienda;font-weight: bold;">Prenom</th>
                                                                                  	...
                                                                                  	while($a=$nwsub->fetch())
                                                                                  	{
                                                                                  		?>
                                                                                  		<tr> 
																					    <td style="color: white;background-color: #818111;font-family: merienda;font-weight: bold;"> <?php echo $a['nom']?></td>
																					    <td style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['prenom']?></td>
