												                   ...
												                   <!--navbar -->
												                    ...
												                    <!--end of treat-->
												                          ...
												                          <!-- center-->
												                                     ...
												                                     <div class="container-fluid text-center " >    
												                                      <div class="row content my_center" style="padding-top: 57px;">
												                                        ...
												                                        <div class="well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0" > 
												                                                ...
												                                                <div class="lead presentation" style="font-size: 28px;color: #d6f52c;font-family: merienda;" >
												                                                	Index des villes
												                                                </div>
												                                                <div style="overflow-x:auto;">
																									  ...
																									  <table class="table table-bordered table-responsive">
																									    <thead>
																									      <tr style="background-color: #18185e;">
																									        <th style="text-align: center">Nom du Ville </th>
																									        <th style="text-align: center">Superficie</th>
																									        <th style="text-align: center">Population (2014) </th>
																									        <th style="text-align: center">Photos</th>
																									      </tr>
																									    </thead>
																									    <tbody>
																									      <tr >
																									        <td style="background-color: #818111;">FES</td>
																									        <td style="text-align: center">424 km2</td>
																									        <td style="text-align: center">1 112 072 hab</td>
																									        <td>
																									        	<!-- Trigger the modal with a button -->
																									        <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal1">Show</button>
																								            </td>
																									      </tr>
																									      <tr>
																									        <td style="background-color: #818111;">RABAT</td>
																									        <td style="text-align: center">118,5 km2</td>
																									        <td style="text-align: center">1 781 740 hab</td>
																									        <td>
																									        <!-- Trigger the modal with a button -->
																											<button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal2">Show</button>

																									        </td>
																									      </tr>
																									      <tr>
																									        <td style="background-color: #818111;">TANGER</td>
																									        <td style="text-align: center">124 km2</td>
																									        <td style="text-align: center">947 952 hab</td>
																									        <td>
																									        <!-- Trigger the modal with a button -->
																											<button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal3">Show</button>
																									  ...
																									  <div class="modal-dialog modal-md">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	...
																									      	<h2 class="lead"style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">Photos de FES</h2>
																									        <img class="img-responsive img-thumbnail"src="images/photos/FES/Fes_Bab_Bou_Jeloud.jpg">
																									         <img class="img-responsive img-thumbnail"src="images/photos/FES/janan_sbile.jpg">
																									          <img class="img-responsive img-thumbnail"src="images/photos/FES/medinaaa.jpg">
																									           <img class="img-responsive img-thumbnail"src="images/photos/FES/qaraouiyn.jpg">
																									            <img class="img-responsive img-thumbnail"src="images/photos/FES/riad_salam_fes.jpg">
																									      </div>
																									...
																									<div id="myModal2" class="modal fade" role="dialog">
																									  <div class="modal-dialog modal-md">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									       <h2 class="lead"style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">Photos de RABAT</h2>
																									        <img class="img-responsive img-thumbnail"src="images/photos/RABAT/Avenue_Mohammed_V_Rabat.jpg">
																									         <img class="img-responsive img-thumbnail"src="images/photos/RABAT/ban-rabat.jpg">
																									          <img class="img-responsive img-thumbnail"src="images/photos/RABAT/Cathédrale_Saint-Pierre_de_Rabat.jpg">
																									           <img class="img-responsive img-thumbnail"src="images/photos/RABAT/jarda.jpg">
																									            <img class="img-responsive img-thumbnail"src="images/photos/RABAT/Rabat-mosque.jpg">
																									      </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
																									...
																									<div id="myModal3" class="modal fade" role="dialog">
																									  <div class="modal-dialog modal-md">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	<h2 class="lead"style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">Photos de TANGER</h2>
																									        <img class="img-responsive img-thumbnail"src="images/photos/TANGER/dartus-tanger.jpg">
																									         <img class="img-responsive img-thumbnail"src="images/photos/TANGER/Tanger_terrain.jpg">
																									          <img class="img-responsive img-thumbnail"src="images/photos/TANGER/tan.jpg">
																									           <img class="img-responsive img-thumbnail"src="images/photos/TANGER/tanger_hercules.jpg">
																									            <img class="img-responsive img-thumbnail"src="images/photos/TANGER/tanger-med-2-apm.jpg">
																									      </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
                                                                                 ...
                                                                                 $articles =$bdd->query('SELECT * from news ORDER BY  id_nws DESC limit 1 ');
