...
if(!empty($_POST['pseudo']) AND !empty($_POST['password']))
                           {
                             ...
                             $admin=$bdd->query("SELECT * From admin where pseudo='$username' and password='$password' ");
...
<body style="background: url(images/photos/back2.jpg) no-repeat ;background-size: cover;">
                   ...
                   <!--------------------------------------------               Header                ---------------------------------------------------------->
                                        ...
                                        <div class="well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0" style="    padding-top: 90px;"> 
                                                                
                                        

                       <h1 id="Login_to" style="font-size: 36px;font-family: merienda;">Login</h1>
                        <h1 class="lead" style="font-size: 21px;font-family: merienda;color: #dbdb12">Bienvenue du Nouveau veuillez saisir vos Informations</h1>
                        <div class="imgcontainer">
                         <img class="img-responsive img-circle my_picture" src="images/photos/me2.jpg">
                         </div>
                         <br/>
                        <form class="form-group row" method="post">
                        <div class="input-group col-xs-offset-2 col-xs-8 " style="margin-bottom: 30px;">
                         <span class="input-group-addon"><i class="glyphicon glyphicon-user" style="color: red;"></i></span>
                         <input id="email" type="text" class="form-control input-lg" name="pseudo" placeholder="pseudo">
                       </div>
                       <div class="input-group col-xs-offset-2 col-xs-8" style="margin-bottom: 30px;">
                       ...
                       <button type="submit" class="btn btn-primary btn-lg " name="connecter" href="admin.php">Login</button>
                     </form>   
