                                            ...
                                            <!--end of treat-->
                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                                ...
                                                                <div class="clearfix visible-ms-block visible-xs-block "></div>
                                                                                 ...
                                                                                 $articles=$bdd->prepare('SELECT * from news where titre like ?"%" ');

                                                                                  ?>


                                                                                <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 ">
                                                                                  <h1 style="font-family: merienda;font-weight: bold;color: yellow;">Search</h1>
                                                                                    <br/>  
                                                                                 ...
                                                                                 <br/>  
                                                                                    ...
                                                                                    $articles->execute(array($_GET['search'])); 
                                                                                    ...
                                                                                    <th style="text-align: center;font-family: merienda;font-weight: bold;">Date de Publication</th>
                                                                                    <th style="text-align: center;font-family: merienda;font-weight: bold;">Titre</th>
                                                                                    <th style="text-align: center;font-family: merienda;font-weight: bold;">Contenu</th>
                                                                                    <th style="text-align: center;font-family: merienda;font-weight: bold;">resume</th>
                                                                                    </tr>
                                                                                    ...
                                                                                    while($a=$articles->fetch())
                                                                                    {
                                                                                      ?>
                                                                                      <tr> 
                                                                                          <td style="color: white;background-color: #818111;font-family: merienda;font-weight: bold;"> <?php echo $a['date_pub']?></td>
                                                                                          <td  style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['titre']?></td>
                                                                                          <td style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['contenu']?></td>
                                                                                          <td  style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['resume']?></td>
                                                                                       </tr>
                                                                                          <?php
                                                                                      }
                                                                                    }
                                                                                     else { ?> <p style="color: white;text-align: center;font-family: merienda;font-weight: bold;font-size:25px;">article introuvable ! </p> <?php
                                                                                   }
                                                                                      ?>
                                                                                    </table>
                                                                                  <?php  if($count!=0)
                                                                                  ...
                                                                                  <?php }
                                                                                    ...
                                                                                    <h3>
                                                                                <span class=" glyphicon glyphicon-arrow-left" style="color: red;" ><a style="color:#ff4d24;" href="Our_Morocco.php"> Accueil</a>
