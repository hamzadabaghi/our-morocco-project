                                            ...
                                            <!--end of treat-->
                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                                ...
                                                                <div class="clearfix visible-ms-block visible-xs-block "></div>
                                                                                 ...
                                                                                 $articles =$bdd->prepare('SELECT * from news where id_nws = ?');
                                                                                 $articles->execute(array($id_aff));
                                                                                ...
                                                                                <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 "> 
                                                                                  ...
                                                                                  <h1 style="font-family: merienda;font-weight: bold;">les Articles</h1>
                                                                                  <br/>
                                                                                  ...
                                                                                  <table class="col-xs-12 table table-bordered table-responsive">
                                                                                    <tr style="background-color: #18185e;">
                                                                                  	...
                                                                                  	while($a=$articles->fetch())
                                                                                  	{
                                                                                  		...
                                                                                  		<tr> 
                                          																					    ...
                                          																					    <td style="color: white;font-family: merienda;font-weight: bold;"> <?php echo $a['titre']?></td>
                                          																					    <td style="color: white;font-family: merienda;font-weight: bold;"> <?php echo $a['contenu']?></td>
                                          																					    <td style="color: white;font-family: merienda;font-weight: bold;"> <?php echo $a['resume']?></td>
                                          																					    </tr>
                                          																					    <?php
                                          																					}
                                          																					?>
                                                                                   ...
                                                                                   <h3>
                                        <span class=" glyphicon glyphicon-arrow-left" style="color: red;" ><a style="color:#ff4d24;" href="Our_Morocco.php"> Accueil </a></span>
