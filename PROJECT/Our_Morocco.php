...
<body style="background: url(images/photos/back2.jpg) no-repeat ;background-size: cover;">
                   ...
                   <!--------------------------------------------               Header                ---------------------------------------------------------->
												                    ...
												                    <!--image background de header-->
												                            ...
												                            <img class="img-responsive logo_site bounceInLeft animated " src="images/photos/logo.png" alt="pic_nav"/>
												                   ...
												                   <!--navbar -->
												                    ...
												                    <!--end of treat-->
												                          ...
												                          <!-- center-->
												                                     ...
												                                     <div class="container-fluid text-center "  >    
												                                      <div class="row content my_center" style="padding-top: 57px;">
												                                        ...
												                                        <div class="sidenav  col-sm-1 hidden-xs" id="mySidenav" >
												                                          <a class="lien_nav heartBeat animated" id="sitem" href="site_et_monument.php" style="padding-left: 0px;padding: 20px;">Lieux</a>
												                                          <a class="lien_nav heartBeat animated" id="villein"href="index_villes.php">Index villes</a>
												                                          <a class="lien_nav heartBeat animated" id="lienut" href="liens_utiles.php">Liens utiles</a>
												                                          <a class="lien_nav heartBeat animated" id="carte" href="https://www.google.com/maps/@33.9996347,-4.9897436,15z"  title=" cliquez pour voir tout le maroc 😍" target="_blank">Carte<br/>Maroc</a>
												                                        </div>
												                                        ...
												                                        <div class="well well-lg visible-xs-block col-xs-10 col-xs-offset-1 col-lg-offset-0 sidenav">
												                                          <p class="lien_nav heartBeat animated"><a href="site_et_monument.php">Sites et Monuments</a></p>
												                                          <p class="lien_nav heartBeat animated"><a href="index_villes.php">Index des villes</a></p>
												                                          <p class="lien_nav heartBeat animated"><a href="liens_utiles.php">Liens utiles</a></p>
												                                          <p class="lien_nav heartBeat animated"><a href="#cartesite">la carte de du pays</a></p>
												                                        </div> 
												                                        ...
												                                        <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 my_gallery "> 
												                                                                
												                                                
												                                                <div class="lead presentation">
												                                                	<span style="color: #d6f52c;" class="fadeInDown animated" >BIENVENUE <span style="color: red;">A</span><span style="color: green;">U</span> MAROC !</span>
												                                                </div>

												                                                
 																								<div > 
												                                        
												                                                <div class="gallery jackInTheBox animated"  >
												                                                  <a  data-toggle="modal" data-target="#myModal1">
												                                                    <img class="img-responsive  " src="images/photos/tetouan.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;"><span class="lead">Tétouan</span><br/>Cliquer ici pour plus d'informations</div>
												                                                </div>
												                                                ...
												                                                <div class="gallery ">
												                                                  <a  data-toggle="modal" data-target="#myModal2">
												                                                    <img class="img-responsive" src="images/photos/Nador_nature.jpeg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;"><span class="lead">Nador</span><br/>Cliquer ici pour plus d'informations</div>
												                                                </div>
												                                                ...
												                                                <div class="gallery jackInTheBox animated ">
												                                                  <a  data-toggle="modal" data-target="#myModal3">
												                                                    <img class="img-responsive" src="images/photos/Rabat.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;"><span class="lead">Rabat</span><br/>Cliquer ici pour plus d'informations</div>
												                                                </div>

												                                                <div class="gallery">
												                                                  <a  data-toggle="modal" data-target="#myModal4">
												                                                    <img class="img-responsive" src="images/photos/Fes_medina_2.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;"><span class="lead">Fes</span><br/>Cliquer ici pour plus d'informations</div>
												                                                </div>
												                                                ...
												                                                <div class="gallery">
												                                                  <a  data-toggle="modal" data-target="#myModal5">
												                                                    <img class="img-responsive" src="images/photos/Chefchaouen_2.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;"><span class="lead">Chefchaouen</span><br/>Cliquer ici pour plus d'informations</div>
												                                                </div>


												                                                <div class="gallery ">
												                                                  <a  data-toggle="modal" data-target="#myModal6">
												                                                    <img class="img-responsive" src="images/photos/dakhla_mer.jpg" alt="Cinque Terre" width="600" height="400">
												                                                  </a>
												                                                  <div class="desc" style="color: #fefffa;padding: 14px;font-family: merienda;"><span class="lead">Dakhla</span><br/>Cliquer ici pour plus d'informations</div>
												                                                </div>
																									  ...
																									  <div class="modal-dialog">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	...
																									      	<h2 class="lead"style="background-color: #949318;margin: 30px;padding:30px;font-family:merienda;">Tétouan</h2>
																									      	<img class="img-responsive img-thumbnail" src="images/photos/tetouan.jpg" alt="Cinque Terre" width="600" height="400"><div style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">
																									      		Description : La ville est située à environ 60 km au sud-est de la ville de Tanger et à proximité du détroit de Gibraltar <br/><br/> <a href="#" target="_blank">cliquer pour plus d'informations</a> </div>
																									...
																									<div id="myModal2" class="modal fade" role="dialog">
																									  <div class="modal-dialog">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									       <h2 class="lead"style="background-color: #949318;margin: 30px;padding:30px;font-family:merienda;">Nador</h2>
																									       <img class="img-responsive img-thumbnail" src="images/photos/Nador_nature.jpeg" alt="Cinque Terre" width="600" height="400">
																									      </div><div style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">
																									      		Description : Nador est située à 150 km d'Al hoceïma (ouest), à 80 km de Berkane (est) et à 100 km de Taourirt (Sud) . <br/><br/> <a href="#"target="_blank" >cliquer pour plus d'informations</a> </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
																									    </div>
																									...
																									<div id="myModal3" class="modal fade" role="dialog">
																									  <div class="modal-dialog">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	<h2 class="lead"style="background-color: #949318;margin: 30px;padding:30px;font-family:merienda;">Rabat</h2>
																									      	 <img class="img-responsive img-thumbnail" src="images/photos/Rabat.jpg" alt="Cinque Terre" width="600" height="400"><div style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">
																									      		Description : La ville est située au bord de l'Atlantique au nord-ouest du Maroc, à 40 km au sud de Kénitra et 240 km au sud-ouest de Tanger . <br/><br/> <a href="#"target="_blank">cliquer pour plus d'informations</a> </div>
																									      </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
																									...
																									<div id="myModal4" class="modal fade" role="dialog">
																									  <div class="modal-dialog">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	<h2 class="lead"style="background-color: #949318;margin: 30px;padding:30px;font-family:merienda;">Fes</h2>
																									      	<img class="img-responsive img-thumbnail" src="images/photos/Fes_medina_2.jpg" alt="Cinque Terre" width="600" height="400"><div style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">
																									      		Description : Fès est une ville du Maroc septentrional, située à 180 km à l'est de Rabat, entre le massif du Rif et le Moyen Atlas. <br/><br/><a href="#"target="_blank">cliquer pour plus d'informations</a> </div>
																									      </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
																									...
																									<div id="myModal5" class="modal fade" role="dialog">
																									  <div class="modal-dialog">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	<h2 class="lead"style="background-color: #949318;margin: 30px;padding:30px;font-family:merienda;">Chefchaouen</h2>
																									      	<img class="img-responsive img-thumbnail" src="images/photos/Chefchaouen_2.jpg" alt="Cinque Terre" width="600" height="400">
																									      	<div style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">
																									      		Description : Chefchaouen ou Chaouen est une ville du nord-ouest du Maroc, bâtie à 600 m d'altitude au pied des monts Kelaa et Meggou, sur la chaîne du Rif . <br/><br><a href="#"target="_blank">cliquer pour plus d'informations</a> </div>
																									      </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
																									...
																									<div id="myModal6" class="modal fade" role="dialog">
																									  <div class="modal-dialog">
																									    ...
																									    <div class="modal-content">
																									      ...
																									      <div class="modal-body">
																									      	<h2 class="lead"style="background-color: #949318;margin: 30px;padding:30px;font-family:merienda;">Dakhla</h2>
																									      	<img class="img-responsive img-thumbnail" src="images/photos/dakhla_mer.jpg" alt="Cinque Terre" width="600" height="400">
																									      	<div style="background-color: #bb1d1d;margin: 30px;padding:30px;font-family:merienda;">
																									      		Description : Dakhla est située sur la côte atlantique du Sahara occidental de fait au sud du Maroc, au bord du golfe du Dakhla. <br/><br/> <a href="#"target="_blank">cliquer pour plus d'informations</a> </div>
																									      </div>
																									      <div class="modal-footer">
																									        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																									      </div>
                                                                                 ...
                                                                                 $articles =$bdd->query('SELECT * from news ORDER BY  id_nws DESC limit 3 ');
                                                                                  ...
                                                                                  ?>
												                                        ...
												                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 sidenavi ">
												                                            ...
												                                            <div class="mynewsletter" class="col-xs-offset-1" style="background-color:#2c4201;padding-top: 15px;">
												                                            <h2 style="color: yellow;font-family:merienda;font-size: 40px;" class="flash animated">News</h2>
																					              ...
																					              <!-- subscribe-->
																					                        ...
																					                        <section class="subscribe text-center">
																								             ...
																								             <div id="myModal8" class="modal fade" role="dialog">
																					                              ...
																					                              <br/>
																					                              <input  class="form-control input-lg" type="email" name="email_news" placeholder="Write your email" style=" margin-top: 5px;">
																					                              <br/><br/>
