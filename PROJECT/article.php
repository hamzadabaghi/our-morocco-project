                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                                ...
                                                                <div class="clearfix visible-ms-block visible-xs-block "></div>
                                                                                ...
                                                                                <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 "> 
                                                                                  ...
                                                                                  <h1 style="font-family: merienda;font-weight: bold;">Gestion des Articles</h1>

                                                                               
                                                                                                        
                                                                                

                                                                                  <h2><a href="aff_article.php" >Afficher tous les Articles</a></h2>
                                                                                  <h2><a href="add_article.php">Ajouter un Article</a></h2>
                                                                                  <h2><a href="sup_article.php">Supprimer un Article</a></h2>
                                                                                  <h2><a href="up_article.php">Modifier un Article</a></h2>
                                                                                  <br/> 
