                                            ...
                                            <!--end of treat-->
                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                            ...
                                                            <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 "> 
                                                              ...
                                                              <h1 style="font-family: merienda;font-weight: bold;">Suppression des articles</h1>
                                                              ...
                                                              <table  class="col-xs-12 table table-bordered table-responsive" >
                                                                ...
                                                                <th style="background-color: #18185e;text-align: center;font-family: merienda;font-weight: bold;">Suppression</th>
                                                              </tr>
                                                                ...
                                                                while($a=$articles->fetch())
                                                                {
                                                                  ...
                                                                  <td><button type="button" class="btn btn-danger btn-md"  onClick="deleteme(<?php echo $a['id_nws']; ?>)" name="Delete" >Delete</button></td>
