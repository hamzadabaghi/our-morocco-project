...
<body style="background: url(images/photos/back2.jpg) no-repeat ;background-size: cover;">
                   ...
                   <!--------------------------------------------               Header                ---------------------------------------------------------->
                                            ...
                                            <!--end of treat-->
                                              ...
                                              <!-- side nav monument  in xs and sm screens...... -->
                                                                ...
                                                                <div class="clearfix visible-ms-block visible-xs-block "></div>
                                                                                 ...
                                                                                 $nwsub =$bdd->query('SELECT * from contact_me ORDER BY  id_msg DESC limit 4');
                                                                                ...
                                                                                <div class=" well well-lg  col-xs-10 col-sm-9 col-md-6 col-lg-8 col-xs-offset-1 col-lg-offset-0 "> 
                                                                                  ...
                                                                                  <h1 style="font-family: merienda;font-weight: bold;">les Messages reçus</h1>
                                                                                    <br/>
                                                                                    <div style="overflow-x:auto;">  
                                                                                  <table class="col-xs-12 table table-bordered table-responsive">
                                                                                    <tr  style="background-color: #18185e;">
                                                                                  	<th style="text-align: center;font-family: merienda;font-weight: bold;">Nom</th>
                                                                                  	<th style="text-align: center;font-family: merienda;font-weight: bold;">Numéro</th>
                                                                                  	<th style="text-align: center;font-family: merienda;font-weight: bold;">Email</th>
                                                                                    <th style="text-align: center;font-family: merienda;font-weight: bold;">Message</th>
                                                                                    </tr>
                                                                                  	<?php
                                                                                  	...
                                                                                  	while($a=$nwsub->fetch())
                                                                                  	{
                                                                                  		?>
                                                                                  		<tr> 
																					    <td style="color: white;background-color: #818111;font-family: merienda;font-weight: bold;"> <?php echo $a['username']?></td>
																					    <td style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['cell']?></td>
																					    <td style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['email']?></td>
                                              <td style="color: white;text-align: center;font-family: merienda;font-weight: bold;"> <?php echo $a['message']?></td>
																					    </tr>
																					    <?php
																					}
																					?>
                                        ...
                                        <h3>
                                        <span class=" glyphicon glyphicon-arrow-left" style="color: red;" ><a style="color:#ff4d24;" href="admin.php"> retour </a></span>
                                        
                                      </h3> 
																				<?php
																					$nwsub->closeCursor(); // Termine le traitement de la requête
